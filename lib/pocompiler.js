 ...
 * @param {number} Maximum allowed length for folded lines
 * @return {Buffer} Compiled PO object
 */
module.exports = function (table, foldLen) {
  var compiler = new Compiler(table, foldLen);
...
Compiler.prototype._addPOString = function (key, value) {
  ...
  var lines = sharedFuncs.foldLine(value, this._foldLen);
